...
;; Keywords: languages
;; Package-Requires: ((emacs "25.1") (dash "2.14.1") (dash-functional "2.14.1") (f "0.20.0") (ht "2.0") (treemacs "2.5"))
;; Version: 0.1
...
(treemacs-define-expandable-node lsp-files
  ...
  :render-action
  (treemacs-render-node
   :icon (lsp-treemacs--diagnostic-icon (rest item))
   :label-form (-let [diag (rest item)]
                 (format (propertize "%s %s %s" 'face 'default)
